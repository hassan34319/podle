...
function SampleCard({title,category,image,rating,price}: Props) {
  return (
    <div className="h-max bg-white rounded-3xl pt-[2vh] pb-[2vh] w-[24%] drop-shadow-lg border-black border-[0.5px] border-opacity-30">
